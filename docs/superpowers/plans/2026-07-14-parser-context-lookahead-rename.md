...
- [ ] **Step 2: Replace the node-stack regression with a lookahead test.**
...
- [ ] **Step 3: Update all pure-lookahead callers only.**
...
- [ ] **Step 1: Update the architecture API list and guidance.**
...
- [ ] **Step 1: Request independent review from a model different from the implementation model.**
...
- [ ] **Step 2: Resolve all confirmed review findings and rerun the affected focused checks.**
...
- [ ] **Step 3: Close the implementation plan according to the documentation protocol.**
