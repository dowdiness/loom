...
- [Remove the public ParserContext lex-mode API](plans/2026-07-26-remove-parser-context-lex-mode-api.md) — accepted breaking-boundary removal; retain private checkpoint state and migrate users to supported lexical mechanisms.
