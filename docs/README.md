...
- [superpowers/plans/2026-07-22-markdown-continuation-decision-refactor.md](superpowers/plans/2026-07-22-markdown-continuation-decision-refactor.md) — implementation plan for the Markdown-local typed continuation decision/consumption refactor
