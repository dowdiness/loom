...
- [superpowers/plans/2026-07-15-block-reparse-ancestor-widening.md](superpowers/plans/2026-07-15-block-reparse-ancestor-widening.md) — active implementation plan for context-aware block-reparse candidate widening after explicit language rejection
...
_Active: [block reparse ancestor widening](superpowers/plans/2026-07-15-block-reparse-ancestor-widening.md) — approved context-aware selector contract; execution waits on the written plan._
