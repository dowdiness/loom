...
- [superpowers/plans/2026-07-13-benchmark-detector-policy.md](superpowers/plans/2026-07-13-benchmark-detector-policy.md) — implementation plan for fail-closed benchmark parsing/inventory checks and explicit gated/informational detector policy (#644)
