...
- [superpowers/specs/2026-07-13-benchmark-inventory-reconciliation-improvements-design.md](superpowers/specs/2026-07-13-benchmark-inventory-reconciliation-improvements-design.md) — approved design for completing candidate evidence and guard readability cleanup in benchmark inventory reconciliation (#712)
- [superpowers/plans/2026-07-13-benchmark-inventory-reconciliation-improvements.md](superpowers/plans/2026-07-13-benchmark-inventory-reconciliation-improvements.md) — implementation plan for measuring final benchmark candidates and clarifying the fail-closed update guard (#712)
