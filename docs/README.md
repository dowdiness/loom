...
- [superpowers/plans/2026-07-13-line-lexer-migration-properties.md](superpowers/plans/2026-07-13-line-lexer-migration-properties.md) — implementation plan for structural QuickCheck generation and an independent exact-string line-lexer skeleton migration oracle
