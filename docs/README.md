...
- [plans/2026-07-fallback-lex.md](plans/2026-07-fallback-lex.md) — implementation plan for `#loom.fallback_lex`, including parser validation, line-mode emission, fixture regeneration, and verification
