...
- [2026-06-11 Separated-list parsing & delimiter-aware child grouping](plans/2026-06-11-separated-list-grouping.md) — seam projection grouping helper + `ParserContext::separated_list` combinator (issue #279)
