...
- [decisions/2026-08-11-markdown-high-level-block-cutover.md](decisions/2026-08-11-markdown-high-level-block-cutover.md) — **Accepted** high-level `parse` / `parse_markdown` projection through the source-bound semantic read; Canopy/Loomark consumers remain unchanged
...
- [decisions/2026-08-10-markdown-block-adapter-cutover.md](decisions/2026-08-10-markdown-block-adapter-cutover.md) — **Superseded** staged direct-CST versus source-aware IR-backed `Block` parity decision
