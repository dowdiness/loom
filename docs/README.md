...
- [plans/2026-08-05-core-collection-ownership-migration.md](plans/2026-08-05-core-collection-ownership-migration.md) — proposed staged migration that seals CST, lexer-result, mode-relex, language-spec, and damage-tracker collection aliases (#783)
...
- [architecture/goal-token-source.md](architecture/goal-token-source.md) — low-level opt-in parser-directed goal tokenization overlay on TokenBuffer; explicit goal caches/steps, invalidation, and reuse-suppression, with no standard Grammar/factory auto-wiring
...
- [superpowers/specs/2026-07-17-loomgen-named-token-sets-design.md](superpowers/specs/2026-07-17-loomgen-named-token-sets-design.md) — accepted #687 design for centralized named token sets and generated membership functions
...
- [superpowers/specs/2026-07-20-markdown-continuation-decision-refactor-design.md](superpowers/specs/2026-07-20-markdown-continuation-decision-refactor-design.md) — implemented Markdown-local continuation action capability and measured plain-inline commit path; no core parser API or frontier integration
...
- [archive/completed-phases/2026-08-01-commonmark-completion-handoff.md](archive/completed-phases/2026-08-01-commonmark-completion-handoff.md) — **Complete** CommonMark 0.31.2 handoff; verified 652/652 clean-pipeline conformance and strict representative incremental parity on `main`
...
- [decisions/2026-07-17-loomgen-named-token-sets.md](decisions/2026-07-17-loomgen-named-token-sets.md) — **Accepted** centralized named token sets, shared membership lowering, and generated `is_<name>` APIs (#687)
...
- [decisions/2026-07-17-loomgen-emitter-checklist.md](decisions/2026-07-17-loomgen-emitter-checklist.md) — **Accepted** loomgen emitter author-side verification checklist (#575)
...
- [decisions/2026-06-17-markdown-ir-recovery-adapter-contract.md](decisions/2026-06-17-markdown-ir-recovery-adapter-contract.md) — **Accepted; amended** `Recovered` carries exact author source while diagnostics carry parser reasons; unresolved reference candidates become ordinary text and product adapters avoid parser chrome
...
- [archive/completed-phases/2026-07-15-markdown-projection-identity.md](archive/completed-phases/2026-07-15-markdown-projection-identity.md) — **Complete** implementation plan for MarkdownIR-owned editor identity alignment, recovery, and view-local projection separation (#341; PR #724)
...
- [archive/completed-phases/2026-07-17-quantifier-unification.md](archive/completed-phases/2026-07-17-quantifier-unification.md) — **Complete** implementation plan for the typed quantifier AST and validated counted bounds (#529)
...
- [development/generated-artifact-integrity.md](development/generated-artifact-integrity.md) — explicit tracked artifact sets and deletion-safe regeneration checks
