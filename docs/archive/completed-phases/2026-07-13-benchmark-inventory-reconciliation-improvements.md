...
**Status:** Complete
**Design:** [Benchmark Inventory Reconciliation Improvements](2026-07-13-benchmark-inventory-reconciliation-improvements-design.md)
...
- [x] **Step 1: Record the pre-change contract**
...
- [x] **Step 2: Make guard argument order match data flow**
...
- [x] **Step 3: Verify the existing behavioral contract**
...
- [x] **Step 1: Resolve exact benchmark selectors**
...
- [x] **Step 2: Verify toolchain and worktree identity**
...
- [x] **Step 3: Run candidate 1 with alternating paired order**
...
- [x] **Step 4: Run candidate 2 with alternating paired order**
...
- [x] **Step 5: Compute classifications before editing the ADR**
...
- [x] **Step 6: Commit no measurement-only changes**
...
- [x] **Step 1: Add both candidate rows to the ADR table**
...
- [x] **Step 2: Update evidence prose**
...
- [x] **Step 5: Update PR #713 evidence**
...
- [x] **Step 2: Run the real detector comparison**
...
- [x] **Step 3: Confirm branch and diff state**
...
- [x] **Step 4: Commit and push any final evidence update**
...
- Updated ADR:
  [docs/decisions/2026-07-13-benchmark-inventory-reconciliation.md](../../decisions/2026-07-13-benchmark-inventory-reconciliation.md)
