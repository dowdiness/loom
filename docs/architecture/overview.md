...
- **`dowdiness/loom`** (`loom/`) — generic parser framework: `core`, `pipeline`, `incremental`, `projection`, `grammar`, `viz`; root exports `Grammar`, `new_imperative_parser`, `new_parser` (unified reactive wrapper post Stage 6)
